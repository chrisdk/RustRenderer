...
export const set_aperture: (a: number) => void;
export const set_ca_strength: (a: number) => void;
export const set_env_background: (a: number) => void;
export const set_exposure: (a: number) => void;
export const set_focus_distance: (a: number) => void;
export const set_grain: (a: number) => void;
...
export const set_vignette: (a: number) => void;
